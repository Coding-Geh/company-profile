					...
					<div class="pt-4 space-y-4">
						<div class="flex justify-center space-x-4">
							...
							<button
								...
								class="relative inline-flex h-7 w-14 items-center rounded-full bg-secondary-200 dark:bg-secondary-700 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:focus:ring-offset-secondary-900"
								aria-label="Toggle theme"
							>
								<!-- Toggle handle -->
								<div class="absolute left-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-white shadow-md transition-transform duration-200 {$theme === 'dark' ? 'translate-x-7' : 'translate-x-0'}">
									{#if $theme === 'light'}
